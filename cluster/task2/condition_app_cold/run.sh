#!/bin/bash
#MSUB -N task2_app_cold
#MSUB -W group_list=hpc2-coe-users
#MSUB -l walltime=12:00:00
#MSUB -j oe
# Submit with (2-node footprint):
#   WORKING_NODES="nAAA nBBB" NEED=2 bash tools/submit_free.sh task2/condition_app_cold/run.sh

set -uo pipefail
CONDITION_DIR="condition_app_cold"
...
export CONDITION="app_cold"
export RESULTS_DIR="$RESULTS_ROOT/task2_app_cold"
mkdir -p "$RESULTS_DIR"

echo ">>> Launching task2 app_cold runner" | tee -a "$RUNNER_LOG"

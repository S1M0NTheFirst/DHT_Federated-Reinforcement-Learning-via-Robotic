"""
Random policy worker — CRIU warm baseline, WSL2 version.
Identical to worker_random_client.py except robot module path is resolved
relative to this file instead of the Docker /app/robot hardcode.
"""
import os, sys

# Resolve dht_frl/robot/ relative to this file
sys.path.insert(0, os.path.join(os.path.dirname(os.path.abspath(__file__)),
                                "..", "dht_frl", "robot"))

import time, json, signal, logging, argparse
import numpy as np, psutil, redis
